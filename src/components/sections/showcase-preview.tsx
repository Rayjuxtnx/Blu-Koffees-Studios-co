  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8">
        {showcaseStories.slice(0, 2).map((story, index) => {
          return (
            <div key={story.id} className="animate-fade-in-up" style={{ animationDelay: `${0.2 + index * 0.2}s`}}>
                <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-accent/50 text-center h-full">
                  <CardHeader>
